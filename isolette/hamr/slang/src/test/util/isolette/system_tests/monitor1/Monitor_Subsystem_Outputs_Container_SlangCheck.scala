...
trait Monitor_Subsystem_Outputs_Container_SlangCheck
  ...
  def next(profile: Monitor_Subsystem_Outputs_Container_Profile): Option[Monitor_Subsystem_Outputs_Container] = {
    return Monitor_Subsystem_Outputs_Container_Profile.nextH(profile)
  }

  def freshRandomLib: RandomLib = {
    return Monitor_Subsystem_Outputs_Container_Util.freshRandomLib
  }

  def getProfiles: MSZ[Monitor_Subsystem_Outputs_Container_Profile] = {
  ...
  def getDefaultProfile: Monitor_Subsystem_Outputs_Container_Profile = {
    return Monitor_Subsystem_Outputs_Container_Profile.getDefaultProfile
  }
