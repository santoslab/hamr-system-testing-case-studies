...
import art.Art
import RTS._
import RTS.system_tests.rts1.Actuation_Subsystem_Outputs_Container_SlangCheck.{NameProvider, TestRow}

// Do not edit this file as it will be overwritten if SystemTestArtifactGen is rerun

class Example_Actuation_Subsystem_Outputs_Container_Test_wSlangCheck
  extends Actuation_Subsystem_Outputs_Container_SlangCheck {
  ...
  def examplePreStateContainerFilter(container: Actuation_Subsystem_Outputs_Container): B = {
