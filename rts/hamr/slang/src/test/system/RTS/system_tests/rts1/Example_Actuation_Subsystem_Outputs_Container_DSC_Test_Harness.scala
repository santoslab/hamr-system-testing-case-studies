...
import org.sireum._
import RTS._
import RTS.system_tests.rts1.Actuation_Subsystem_Outputs_Container_SlangCheck.TestRow

// Do not edit this file as it will be overwritten if SystemTestArtifactGen is rerun

object Example_Actuation_Subsystem_Outputs_Container_DSC_Test_Harness extends App {
  ...
  override def main(args: ISZ[String]): Z = {
    ...
    val instance = new Example_Actuation_Subsystem_Outputs_Container_DSC_Test_Harness()
...
class Example_Actuation_Subsystem_Outputs_Container_DSC_Test_Harness
  extends Example_Actuation_Subsystem_Outputs_Container_Test_wSlangCheck
  with Actuation_Subsystem_Outputs_Container_DSC_Test_Harness {

  override def next(): RTS.system_tests.rts1.Actuation_Subsystem_Outputs_Container = {
    val testRow = testMatrix.get(getTestId()).get
    return Actuation_Subsystem_Outputs_Container_Profile.next(testRow.profile)
  }
