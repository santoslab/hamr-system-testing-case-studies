...
import art._
import RTS._
import RTS.Actuation.{Actuator_i_actuationSubsystem_saturationActuatorUnit_saturationActuator_actuator => component}
...
object Actuator_i_actuationSubsystem_saturationActuatorUnit_saturationActuator_actuator_Bridge {
  ...
  @datatype class EntryPoints(
    ...
    def initialise(): Unit = {
      Actuator_i_actuationSubsystem_saturationActuatorUnit_saturationActuator_actuator_EntryPoint_Companion.pre_initialise()

      // implement the following method in 'component':  def initialise(api: Actuator_i_Initialization_Api): Unit = {}
      component.initialise(initialization_api)

      Actuator_i_actuationSubsystem_saturationActuatorUnit_saturationActuator_actuator_EntryPoint_Companion.post_initialise()

      Art.sendOutput(eventOutPortIds, dataOutPortIds)
    }

    def compute(): Unit = {
      Actuator_i_actuationSubsystem_saturationActuatorUnit_saturationActuator_actuator_Injection_Service.pre_receiveInput()

      Art.receiveInput(eventInPortIds, dataInPortIds)

      Actuator_i_actuationSubsystem_saturationActuatorUnit_saturationActuator_actuator_EntryPoint_Companion.pre_compute()

      // implement the following in 'component':  def timeTriggered(api: Actuator_i_Operational_Api): Unit = {}
      component.timeTriggered(operational_api)

      Actuator_i_actuationSubsystem_saturationActuatorUnit_saturationActuator_actuator_EntryPoint_Companion.post_compute()
