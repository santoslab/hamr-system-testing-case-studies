...
import art._
import RTS._
import RTS.Actuation.{CoincidenceLogic_i_actuationSubsystem_actuationUnit2_saturationLogic_coincidenceLogic => component}
...
object CoincidenceLogic_i_actuationSubsystem_actuationUnit2_saturationLogic_coincidenceLogic_Bridge {
  ...
  @datatype class EntryPoints(
    ...
    def initialise(): Unit = {
      CoincidenceLogic_i_actuationSubsystem_actuationUnit2_saturationLogic_coincidenceLogic_EntryPoint_Companion.pre_initialise()

      // implement the following method in 'component':  def initialise(api: CoincidenceLogic_i_Initialization_Api): Unit = {}
      component.initialise(initialization_api)

      CoincidenceLogic_i_actuationSubsystem_actuationUnit2_saturationLogic_coincidenceLogic_EntryPoint_Companion.post_initialise()

      Art.sendOutput(eventOutPortIds, dataOutPortIds)
    }

    def compute(): Unit = {
      CoincidenceLogic_i_actuationSubsystem_actuationUnit2_saturationLogic_coincidenceLogic_Injection_Service.pre_receiveInput()

      Art.receiveInput(eventInPortIds, dataInPortIds)

      CoincidenceLogic_i_actuationSubsystem_actuationUnit2_saturationLogic_coincidenceLogic_EntryPoint_Companion.pre_compute()

      // implement the following in 'component':  def timeTriggered(api: CoincidenceLogic_i_Operational_Api): Unit = {}
      component.timeTriggered(operational_api)

      CoincidenceLogic_i_actuationSubsystem_actuationUnit2_saturationLogic_coincidenceLogic_EntryPoint_Companion.post_compute()
