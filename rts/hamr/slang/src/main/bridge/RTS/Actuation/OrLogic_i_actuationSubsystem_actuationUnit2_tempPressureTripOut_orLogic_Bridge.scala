...
import art._
import RTS._
import RTS.Actuation.{OrLogic_i_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic => component}
...
object OrLogic_i_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic_Bridge {
  ...
  @datatype class EntryPoints(
    ...
    def initialise(): Unit = {
      OrLogic_i_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic_EntryPoint_Companion.pre_initialise()

      // implement the following method in 'component':  def initialise(api: OrLogic_i_Initialization_Api): Unit = {}
      component.initialise(initialization_api)

      OrLogic_i_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic_EntryPoint_Companion.post_initialise()

      Art.sendOutput(eventOutPortIds, dataOutPortIds)
    }

    def compute(): Unit = {
      OrLogic_i_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic_Injection_Service.pre_receiveInput()

      Art.receiveInput(eventInPortIds, dataInPortIds)

      OrLogic_i_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic_EntryPoint_Companion.pre_compute()

      // implement the following in 'component':  def timeTriggered(api: OrLogic_i_Operational_Api): Unit = {}
      component.timeTriggered(operational_api)

      OrLogic_i_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic_EntryPoint_Companion.post_compute()
